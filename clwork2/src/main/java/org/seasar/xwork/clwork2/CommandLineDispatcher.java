package org.seasar.xwork.clwork2;
...
public class CommandLineDispatcher {
	...
	public String dispatch(String actionName, String[] args) throws Exception {
		...
		configurationManager = XWorkTestCaseHelper.loadConfigurationProviders(
				configurationManager,
				new ConfigurationProvider[] { configurationProvider });
		Configuration configuration = configurationManager.getConfiguration();
		Container container = configuration.getContainer();
		ActionProxyFactory actionProxyFactory = (ActionProxyFactory) container
